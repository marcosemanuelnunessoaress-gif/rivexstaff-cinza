...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('topcall')
    .setDescription('Mostra o ranking de chamadas.')
  ...
  async execute(interaction) {
    ...
    const ranking = buscarRanking(guildId, 'call', periodo, 10);
    ...
    const embed = criarEmbed({
      titulo: '<:kosame_speaker:1495835243637243944> Ranking de Chamadas',
